...
public class Stages {
	...
	public void giveAttributesPoints(int attribute_points, Hero myHero) throws UnsupportedAudioFileException, IOException, LineUnavailableException {//A method that distributes the attribute points
		int key = 0;
